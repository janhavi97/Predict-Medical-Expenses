...
When considering the factors that influence medical charges, they can be ranked in order of importance as follows:
1. smoker
2. age
3. bmi
4. children
...
The graph predicts medical expenses for smokers, showing an upward trend where expenses increase with age fopr smoker.
...
The RMSE loss has reduced by not by a large margin. The loss reduced from 5722 to 5718. We see the weights decresing in value.
...
The RMSE loss has reduced by not by a large margin. The loss reduced from 4662 to 4608. We see the weights decresing in value.
